...
DEFAULT_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_securities_agent_plan.json"
DEFAULT_BLUEPRINT_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "agent_training_blueprint.json"
DEFAULT_WORK_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_first_work_session.json"
DEFAULT_WORK_LOG = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_work_log.jsonl"
DEFAULT_TEAM_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_clone_team_session.json"
DEFAULT_TEAM_LOG = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_clone_team_log.jsonl"
DEFAULT_FAMILY_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_family_lineage.json"
DEFAULT_ASSESSMENT_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_doctoral_assessment.json"
DEFAULT_INSTITUTIONAL_REVIEW_OUTPUT = (
    PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_institutional_review.json"
)
DEFAULT_LEARNING_LEDGER_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_learning_ledger.json"
DEFAULT_COHORT_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_specialist_cohort.json"
DEFAULT_BUNDLE_OUTPUT_DIR = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_agent_release_bundle"
DEFAULT_MANIFEST_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_agent_manifest.json"
DEFAULT_AGENT_RUN_OUTPUT = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_agent_run.json"
DEFAULT_AGENT_RUN_LOG = PROJECT_ROOT / "apps" / "ai-talent-foundry" / "runs" / "shinyong_agent_run_log.jsonl"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    blueprint.add_argument("--name", default="신용")
    ...
    start_console.add_argument("--output-dir", required=True)
    ...
    onboard.add_argument("--name", default="신용")
    ...
    onboard.add_argument("--output-dir", required=True)
    ...
    raise_command.add_argument("--output-dir", required=True)
